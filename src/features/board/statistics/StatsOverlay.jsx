      ...
      <div className={styles.panel} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.subtitle}>
              You focused for <strong>24h 15m</strong> this week. Maintaining deep state.
            </p>
          </div>
        ...
        <div className={styles.filtersRow}>
          <div className={styles.filterGroup}>
            ...
            <button className={styles.filterBtn}>Project: Design System ▾</button>
          ...
          {Object.entries(grouped).map(([date, tasks]) => (
            <div key={date}>
              ...
              <div className={view === "grid" ? styles.taskGrid : styles.taskColumn}>
                {tasks.map((task) => {
                  const progress = (task.checklist.done / task.checklist.total) * 100;
                    ...
                    <div key={task.id} className={styles.taskCard}>
                      <div className={styles.taskCardHeader}>
                        <div>
                          ...
                          <span className={`${styles.taskTag} ${styles[task.tagClass]}`}>
                            {task.tag}
                          </span>
                        </div>
